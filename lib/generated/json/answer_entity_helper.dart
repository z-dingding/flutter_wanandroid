...
answerEntityFromJson(AnswerEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = AnswerData().fromJson(json['data']);
	}
...
Map<String, dynamic> answerEntityToJson(AnswerEntity entity) {
...
answerDataFromJson(AnswerData data, Map<String, dynamic> json) {
	...
	if (json['datas'] != null) {
		data.datas = (json['datas'] as List).map((v) => AnswerDataDatas().fromJson(v)).toList();
	}
	if (json['offset'] != null) {
...
Map<String, dynamic> answerDataToJson(AnswerData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
answerDataDatasFromJson(AnswerDataDatas data, Map<String, dynamic> json) {
	...
	if (json['tags'] != null) {
		data.tags = (json['tags'] as List).map((v) => AnswerDataDatasTags().fromJson(v)).toList();
	}
	if (json['title'] != null) {
...
Map<String, dynamic> answerDataDatasToJson(AnswerDataDatas entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
answerDataDatasTagsFromJson(AnswerDataDatasTags data, Map<String, dynamic> json) {
	if (json['name'] != null) {
...
Map<String, dynamic> answerDataDatasTagsToJson(AnswerDataDatasTags entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
