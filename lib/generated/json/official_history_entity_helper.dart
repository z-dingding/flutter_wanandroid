...
officialHistoryEntityFromJson(OfficialHistoryEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = OfficialHistoryData().fromJson(json['data']);
	}
...
Map<String, dynamic> officialHistoryEntityToJson(OfficialHistoryEntity entity) {
...
officialHistoryDataFromJson(OfficialHistoryData data, Map<String, dynamic> json) {
	...
	if (json['datas'] != null) {
		data.datas = (json['datas'] as List).map((v) => OfficialHistoryDataDatas().fromJson(v)).toList();
	}
	if (json['offset'] != null) {
...
Map<String, dynamic> officialHistoryDataToJson(OfficialHistoryData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
officialHistoryDataDatasFromJson(OfficialHistoryDataDatas data, Map<String, dynamic> json) {
	...
	if (json['tags'] != null) {
		data.tags = (json['tags'] as List).map((v) => OfficialHistoryDataDatasTags().fromJson(v)).toList();
	}
	if (json['title'] != null) {
...
Map<String, dynamic> officialHistoryDataDatasToJson(OfficialHistoryDataDatas entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
officialHistoryDataDatasTagsFromJson(OfficialHistoryDataDatasTags data, Map<String, dynamic> json) {
	if (json['name'] != null) {
...
Map<String, dynamic> officialHistoryDataDatasTagsToJson(OfficialHistoryDataDatasTags entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
