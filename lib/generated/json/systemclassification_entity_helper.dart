...
systemclassificationEntityFromJson(SystemclassificationEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = SystemclassificationData().fromJson(json['data']);
	}
...
Map<String, dynamic> systemclassificationEntityToJson(SystemclassificationEntity entity) {
...
systemclassificationDataFromJson(SystemclassificationData data, Map<String, dynamic> json) {
	...
	if (json['datas'] != null) {
		data.datas = (json['datas'] as List).map((v) => SystemclassificationDataDatas().fromJson(v)).toList();
	}
	if (json['offset'] != null) {
...
Map<String, dynamic> systemclassificationDataToJson(SystemclassificationData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
systemclassificationDataDatasFromJson(SystemclassificationDataDatas data, Map<String, dynamic> json) {
...
Map<String, dynamic> systemclassificationDataDatasToJson(SystemclassificationDataDatas entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
