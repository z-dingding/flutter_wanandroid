...
systemlistEntityFromJson(SystemlistEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = (json['data'] as List).map((v) => SystemlistData().fromJson(v)).toList();
	}
...
systemlistDataFromJson(SystemlistData data, Map<String, dynamic> json) {
	if (json['children'] != null) {
		data.children = (json['children'] as List).map((v) => SystemlistDataChildren().fromJson(v)).toList();
	}
...
systemlistDataChildrenFromJson(SystemlistDataChildren data, Map<String, dynamic> json) {
	if (json['children'] != null) {
...
Map<String, dynamic> systemlistDataChildrenToJson(SystemlistDataChildren entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
